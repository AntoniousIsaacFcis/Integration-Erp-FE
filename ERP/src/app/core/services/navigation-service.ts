...
{ id: '1', label: 'MENU.DASHBOARD', path: '/dashboard', icon: 'lucideLayoutDashboard' },
  ...
  { id: '3', label: 'MENU.DEPARTMENTS', path: '/departments', icon: 'lucideBuilding2' },
  { id: '4', label: 'MENU.JOB_LEVELS', path: '/job-levels', icon: 'lucideAlignEndVertical' },
  { id: '5', label: 'MENU.SHIFT_TYPES', path: '/shift-types', icon: 'lucideClock3' },
  { id: '6', label: 'MENU.SHIFT_MANAGEMENT', path: '/shifts', icon: 'lucideCalendar' },
