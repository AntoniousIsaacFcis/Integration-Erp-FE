...
import { lucideCheckCircle, lucideCirclePlus, lucideCloudUpload, lucidePlus, lucideUserPlus } from '@ng-icons/lucide';
...
@Component({
  ...
  providers: [provideIcons({ lucideCirclePlus, lucideUserPlus, lucideCloudUpload, lucideCheckCircle })],
